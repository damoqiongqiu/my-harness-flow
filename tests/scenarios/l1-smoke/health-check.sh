...
echo ""
echo "4. 品牌中性扫描:"
check "无来源项目关键词" "! grep -rni 'superpowers\|obra\|humanlayer\|anthropic\|Terry-Mao\|AICodingFlow' $ROOT --exclude-dir=.git --exclude-dir=.workbuddy --exclude-dir=deliverables --exclude-dir=tests | grep -v README.md | grep -v CHANGELOG.md | grep -q ."
